...
public class CustomInstantDeserializer<T extends Temporal>
    extends DateTimeDeserializerBase<T> {
  ...
  public T deserialize(JsonParser parser, DeserializationContext context) throws IOException {
    ...
    switch (parser.getCurrentTokenId()) {
      case JsonTokenId.ID_NUMBER_FLOAT: {
        ...
        int nanoseconds = (int) ((value.doubleValue() - seconds) * 1_000_000_000L);
      ...
      case JsonTokenId.ID_STRING: {
        ...
        try {
          ...
          throw JsonMappingException.from(parser, "Failed to parse date: " + string, e);
        }
        return value;
      }
    }
    throw JsonMappingException.from(parser,
            "Expected type float, integer, or string. Found: " + parser.currentToken());
  }
