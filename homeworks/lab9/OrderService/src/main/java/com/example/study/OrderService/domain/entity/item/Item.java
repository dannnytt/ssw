package com.example.study.OrderService.domain.entity.item;

import com.example.study.OrderService.domain.entity.order.OrderDetail;
import com.example.study.OrderService.domain.value.measurements.Weight;
